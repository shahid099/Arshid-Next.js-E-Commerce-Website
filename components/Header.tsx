...
const Header = () => {
  ...
  return (
    <header className="w-full flex flex-col fixed top-0 left-0 z-50 bg-gray-900">
      {/* --- Top Bar --- */}

      {isMobile ? (
        // Mobile View
        <>
          <div className="flex items-center  text-white px-4 md:px-6 py-2 gap-4">
            {/* Logo */}
        ...
        (
          <>
            ...
            <div className="flex items-center bg-gray-900 text-white px-4 md:px-6 py-2 gap-4">
              {/* Logo */}
              <Link href="/" className="lg:text-2xl sm:text-xl font-bold text-yellow-400">
                MyStore
              </Link>
